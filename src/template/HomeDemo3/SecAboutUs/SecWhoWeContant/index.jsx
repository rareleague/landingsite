  ...
  return (
    <div className="col-12 col-lg-6">
        <div className="who-we-contant">
            ...
            <h4 data-aos="fade-up">$CRIC Airdrops</h4>
            <p data-aos="fade-up">Support of OG members means everything to us, and we will revert that love with’em raining CricCoins</p>
